...
$prefor="SELECT EP1.id_entregaPreformas, EP1.fecha_entrega, (U1.nombre_usuario) entrego, U1.turno FROM entrega_preformas EP1, entrega_preformas EP2, usuarios U1 WHERE U1.id_usuario=EP1.id_usuarioEntrega GROUP BY  EP1.id_entregaPreformas";
$entregaPreformas=mysqli_query($conexion,$prefor);
$filaEntregaPreformas=mysqli_num_rows($entregaPreformas);
$resin="SELECT ER1.id_entregaResina, ER1.fecha_entrega, (U1.nombre_usuario) entrego, U1.turno FROM entrega_resina ER1, entrega_resina ER2, usuarios U1, usuarios U2 WHERE U1.id_usuario=ER1.id_usuarioEntrega GROUP BY  ER1.id_entregaResina";
