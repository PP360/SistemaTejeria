...
//                $suma+= $_SESSION['cantidadPreforma'][$i]*$fila['usd']/1000*$fila['tipo_cambio'];
                ...
                echo "<tr><td>".$fila['gramaje']."</td><td>".$_SESSION['cajasPreformas'][$i]."</td><td>".number_format($_SESSION['cantidadPreforma'][$i]/$_SESSION['cajasPreformas'][$i],0)."</td><td>".$fila['usd']."</td><td>".$fila['tipo_cambio']."</td><td>".number_format($_SESSION['cantidadPreforma'][$i]*$fila['usd']*$fila['tipo_cambio'],4)."</td></tr>";
