                                    ...
                                    <div class="card">
                                        <div class="card-block">
                                            <div class="card-title-block">
                                                <h3 class="title">
                                                    <form action="actuali_cliente.php" method="post">
                                                        ...
                                                        <center>
                                                            <div class="card card-block sameheight-item">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <input type="text" name="nombre_cliente" id="nombre" class="form-control" placeholder="" autofocus required maxlength="50" value="<?php echo $row['nombre_cliente'];?>" > </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-2 form-control-label">RFC</label>
                                                                    <div class="col-sm-6">
                                                                        <input type="text" name="rfc" id="rfc" class="form-control" placeholder="" autofocus required maxlength="50" value="<?php echo $row['rfc'];?>" > </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-2 form-control-label">Dirección</label>
                                                                    <div class="col-sm-6">
                                                                        <input type="text" name="direccion" id="direccion" class="form-control" placeholder="" required maxlength="100" value="<?php echo $row['direccion'];?>" >
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-2 form-control-label">Email</label>
                                                                    <div class="col-sm-6">
                                                                        <input type="email" name="email" id="email" class="form-control" placeholder="" required maxlength="50" value="<?php echo $row['email'];?>"> </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-2 form-control-label">Teléfono</label>
                                                                    <div class="col-sm-6">
                                                                        <input type="text" name="telefono" id="telefono" class="form-control" placeholder="" required maxlength="15" value="<?php echo $row['telefono'];?>" > </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-2 form-control-label">Celular</label>
                                                                    <div class="col-sm-6">
                                                                        <input type="text" name="celular" id="celular" class="form-control" placeholder="" required maxlength="15" value="<?php echo $row['celular'];?>" > </div>
                                                                </div>
