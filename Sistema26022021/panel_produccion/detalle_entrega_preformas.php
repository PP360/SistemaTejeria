...
$prefor="SELECT (U.nombre_usuario) entrego,(U.turno) turno, P.gramaje, P.unidad_medida, EP.id_entregaPreformas, DEP.cantidad FROM entrega_preformas EP,  usuarios U,  detalle_entregapreformas DEP,preformas P WHERE EP.id_entregaPreformas=DEP.id_detalleEntregaPreformas AND P.id_preforma=DEP.id_preforma AND DEP.id_detalleEntregaPreformas='$id' GROUP BY  EP.id_entregaPreformas";
