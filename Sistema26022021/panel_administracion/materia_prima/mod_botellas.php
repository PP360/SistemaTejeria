...
$query="SELECT  * FROM botellas where id_botella='$id'";
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title">
                                                <form action="actuali_botellas.php" method="post">
                                                    <?php while ($row=mysqli_fetch_array($resina)) { ?>
                                                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                                                    <center>
                                                        <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-archive"></i> Actualizar:  <?php echo $row['tipo_botella'];?> </button>
                                                    </center>
                                                    </h3> </div>
                                                    ...
                                                    <center>
                                                        <div class="card card-block sameheight-item">
                                                            ...
                                                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-2 form-control-label">Nombre</label>
                                                                <div class="col-sm-6"> <input type="text" name="tipo_botella" id="tipo_botella" class="form-control" placeholder="" required maxlength="100" value="<?php echo $row['tipo_botella']; ?>" > </div>
                                                            </div>
