...
$ComprasPreformasAjuste="Select ID_compraPreformas,fecha_compra FROM Compra_Preformas";
$CPA=mysqli_query($conexion,$ComprasPreformasAjuste);
$FilasCPA=mysqli_num_rows($CPA);
?>
        ...
        $(document).ready(function() {
            ...
            function calcularPreformas() {
                ...
                if (tipoPreforma == 1) {
                    ...
                    document.getElementById("cantidadCajasCompradas").value = cajas;
                    var cajasPrueba = document.getElementById("cantidadCajasCompradas").value;
                    console.log("Input hidden");
                    console.log(cajasPrueba);
                    //Preforma 13 Grs CSN 26
                    ...
                    totalPreformasCompradas = 13440 * cajas;
                    document.getElementById("cantidad").value = totalPreformasCompradas;
                    document.getElementById("cantidadCajasCompradas").value = cajas;
                    // Preforma 18 Grs CSN 26
                } else if (tipoPreforma == 13) {
                    totalPreformasCompradas = 13008 * cajas;
                    document.getElementById("cantidad").value = totalPreformasCompradas;
                    document.getElementById("cantidadCajasCompradas").value = cajas;
                    ...
                    document.getElementById("cantidad").value = totalPreformasCompradas;
                    document.getElementById("cantidadCajas").value = cajas;
                } 
                ...
                //Preforma 24 Grs Corvaglia
                    ...
                    totalPreformasCompradas = 13158 * cajas;
                    document.getElementById("cantidad").value = totalPreformasCompradas;
                    document.getElementById("cantidadCajas").value = cajas;
                } 
