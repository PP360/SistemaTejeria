...
$query="SELECT CP.id_compraPreformas,  CP.codigo_compraPreformas, DATE(CP.fecha_compra) , SUM(CP.total_compra) FROM compra_preformas CP  GROUP BY CP.codigo_compraPreformas  ORDER BY CP.id_compraPreformas";
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title">
                                                <center>
                                                    <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-archive"></i> Listado de compra de preformas</button>
                                                </center>
                                        ...
                                        <section>
                                            ...
                                            <center>
                                                <form action="../reportes/compras_preformas.php" method="post">
                                                    <strong> Desde&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                            ...
                                            <div class="table-responsive">
                                                <table id="example" class="table table-striped table-bordered table-hover flip-content" id="tabla" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo $id ?></td>
                                                            <td><?php echo $row['DATE(CP.fecha_compra)'];?></td>
                                                            <td><strong>$ <?php echo round( $row['SUM(CP.total_compra)'],4);?></strong></td>
                                                            <td> <a href="../reportes/detalle_CompraPreformas.php?Cod=<?php echo base64_encode($row['codigo_compraPreformas'])?>">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title">
                                                <center>
                                                    <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-archive"></i> Listado de compra  preformas</button>
                                                </center>
                                        ...
                                        <section class="">
                                            ...
                                            <center>
                                                <h5> <i class="fa fa-close" aria-hidden="true"></i> No se han  agregado nuevas compras de preformas al sistema, puedes agregar uno dando clic en  <a href="comprar_preformas.php"><button title="Nueva compra"  class="btn  btn-sm rounded-s btn-danger test"> <i class="fa fa-cart-plus  fa-lg"></i></button></a> </h5>
