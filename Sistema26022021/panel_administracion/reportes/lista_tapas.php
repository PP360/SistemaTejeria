...
$pdf->Cell(14,8,"",0);
$pdf->Cell(10,8, 'No.', 1 );
$pdf->Cell(40,8,utf8_decode('Presentación'), 1);
$pdf->Cell(40,8, 'No.de Tapa', 1);
$pdf->Cell(35,8, 'Precio ind.', 1);
$pdf->Cell(35,8, 'Millar x caja', 1);
$pdf->Ln();
...
while($arreglo=mysqli_fetch_array($tapas))
{
    ...
    $pdf->Cell(14,8,"",0);
    $pdf->Cell(10,8, $id, 1);
    $pdf->Cell(40,8, $arreglo['Presentacion'], 1);
    $pdf->Cell(40,8, $arreglo['tamano'], 1);
    $pdf->Cell(35,8, $arreglo['precio'], 1);
    $pdf->Cell(35,8, $arreglo['millarcaja'], 1);
    $id++;
    $pdf->Ln(8);
}
    $pdf->Ln();
