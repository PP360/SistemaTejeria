...
for($i = 0;$i< $_SESSION['contadorTapas'];$i++){
    ...
    while($fila = mysqli_fetch_array($resultado)) {
        ...
        else
        {
            ...
            .number_format(($_SESSION['cajas'][$i]*$fila['millarcaja']),4)."</td></tr>";
            $suma+= $_SESSION['cajas'][$i]*$fila['millarcaja']; 
...
echo "<tbody><tr><td></td><td></td><td><h5> <strong>Flete</strong></h5></td><td><h5>$".number_format(($costoFlete),4)."</h5></td></tr></tbody>";
echo "<tbody><tr><td></td><td></td><td><h5> <strong>Total</strong></h5></td><td><h5>$".number_format(($suma+$costoFlete),4)."</h5></td></tr></tbody>";
echo"</table>";
echo "</div>";
