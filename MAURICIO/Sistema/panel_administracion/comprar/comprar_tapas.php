    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function calcularTapas() {
                ...
                var millarCajaTapas=tipoTapa.substring(posicion+1);
                var idTapa=tipoTapa.substring(0,posicion);
                totalTapasCompradas=millarCajaTapas*cajas;
                totalTapasCompradas=Math.round(totalTapasCompradas);
                            ...
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-2 form-control-label">Tamaño</label>
                                <div class="col-sm-10">
                                    <select class="form-control form-control-sm" name="tamano" id="tamano">
                                        ...
                                        <?php echo'<OPTION VALUE="'.$row['id_tapa'].'-'.$row['millarcaja'].'">'.$row['tamano'].'</OPTION>';?>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
