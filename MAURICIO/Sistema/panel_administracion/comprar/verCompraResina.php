...
$query="SELECT CR.id_compraResina, CR.codigo_compraResina,DATE(CR.fecha_compra),SUM(CR.total_compra)FROM compra_resina CR  GROUP BY CR.codigo_compraResina";
$compraResina=mysqli_query($conexion,$query);
$filas=mysqli_num_rows($compraResina);
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title">
                                                <center>
                                                    <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-archive"></i> Listado de compra de resinas</button>
                                                </center>
                                        ...
                                        <section>
                                            ...
                                            <center>
                                                <form action="../reportes/compras_resinas.php" method="post">
                                                    <strong> Desde&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                            ...
                                            <div class="table-responsive">
                                                <table id="example" class="table table-striped table-bordered table-hover flip-content" id="tabla" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo $id ?></td>
                                                            <td><?php echo $row['DATE(CR.fecha_compra)'];?></td>
                                                            <td><strong>$ <?php echo round($row['SUM(CR.total_compra)'],4);?></strong></td>
                                                            <td> <a href="../reportes/detalle_CompraResina.php?Cod=<?php echo base64_encode($row['codigo_compraResina'])?>">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <section class="">
                                            ...
                                            <center>
                                                <h5> <i class="fa fa-close" aria-hidden="true"></i> No se han  agregado nuevas compras de resinas al sistema, puedes agregar uno dando clic en  <a href="comprar_resina.php"><button title="Nueva compra"  class="btn  btn-sm rounded-s btn-danger test"> <i class="fa fa-cart-plus  fa-lg"></i></button></a> </h5>
