...
$consultaAjuste1= mysqli_query($conexion,'SELECT MAX(ID_Ajuste) as ID_Ajuste FROM ajuste_preformas LIMIT 1');
$consulta = mysqli_fetch_array($consultaAjuste1);
$IDAjuste=(empty($consulta['ID_Ajuste']) ? 1 : $consulta['ID_Ajuste']+=1);

$CPA=mysqli_query($conexion,"Select Max(ID_compraPreformas) as ID_compraPreformas FROM Compra_Preformas LIMIT 1");
$consultaCPA=mysqli_fetch_array($CPA);
$idCompraPRE=(empty($consultaCPA['ID_compraPreformas']) ? 1 : $consultaCPA['ID_compraPreformas']);
...
<head>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#CajasPreformas").change(function(event) {
            ...
            function calcularPreformas() {
                ...
                console.log(document.getElementById("CajasPreformas").value);
                console.log(document.getElementById("gramaje").value);
                console.log(flete);
                var cajas = (document.getElementById("CajasPreformas").value);

                //var cajas = 3;
                var tipoPreforma = document.getElementById("gramaje").value;
                console.log(tipoPreforma);
                var totalPreformasCompradas = 0;
                var posicion=tipoPreforma.lastIndexOf('-');
                var millarCajaPreformas=tipoPreforma.substring(posicion+1);
                var idPreformaElegida=tipoPreforma.substring(0,posicion);
                console.log("Millar caja:");
                console.log(millarCajaPreformas);
                console.log("IdPreforma Elegida:");
                console.log(idPreformaElegida);
                var totalPreformasCompradas=cajas*millarCajaPreformas*1000;
                totalPreformasCompradas=Math.round(totalPreformasCompradas);
...
<body>
    ...
    <div class="main-wrapper">
        <div class="app" id="app">
            ...
            <div class="modal fade" id="registroCompraPreforma" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-2 form-control-label">Gramaje</label>
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control form-control-sm  " name="gramaje" id="gramaje">
                                        ...
                                        <?php echo'<OPTION VALUE="'.$row['id_preforma'].'-'.$row['millarcaja'].'">'.$row['gramaje'].'</OPTION>';?>
                            ...
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-2 form-control-label">Cajas</label>
                                <div class="col-sm-10">
                                    <input type="text" name="CajasPreformas" id="CajasPreformas" class="form-control" placeholder="" required maxlength="10" autofocus onkeypress="numeros()">
                                </div>
                            ...
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-2 form-control-label">Preformas</label>
                                ...
                                <div class="col-sm-10"> <input type="text" name="cantidad" id="cantidad" value="0" class="form-control" placeholder="" maxlength="10" onkeypress="numeros()"> </div>
                            </div>
                            <div class="col">
                                <div class="col-sm-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" class="form-control boxed rounded-s" id="cantidadCajasCompradas" name="cantidadCajasCompradas" value="1">
                                </div>
                                <div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-3 form-control-label">No. de Ajuste</label>
                                <div class="col-sm-9"> 
                                <input type="text" name="IDAjuste" id="IDAjuste" class="form-control" placeholder=""
                                 disabled value="<?php echo $IDAjuste; ?>" autofocus onkeypress="numeros()">
                                
                                 </div>
                            </div>
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-3 form-control-label">IdCompra</label>
                                <div class="col-sm-9">
                                <input type="text" name="idCompraPRE" id="idCompraPRE" class="form-control" placeholder="" disabled 
                                value="<?php echo $idCompraPRE; ?>" autofocus onkeypress="numeros()">
                            ...
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-3 form-control-label">No. De Caja</label>
                                <div class="col-sm-9">
                                    <input type="text" name="NumeroCaja" id="NumeroCaja" class="form-control" placeholder="" required maxlength="10" autofocus >
                                </div>

                            </div>
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-3 form-control-label">Cant. Excedente</label>
                                <div class="col-sm-9">
                                    <input type="text" name="cantidadExcedente" id="cantidadExcedente" class="form-control" placeholder="" required maxlength="10" autofocus >
                                </div>
