...
$query="SELECT tapas.id_tapa, tapas.tamano,  tapas.unidad_medida, inventario_tapas.id_tapa, inventario_tapas.cantidad, inventario_tapas.id_inventarioTapas FROM tapas, inventario_tapas WHERE inventario_tapas.id_tapa=tapas.id_tapa ";
$inventarioTapas=mysqli_query($conexion,$query);
$filas=mysqli_num_rows($inventarioTapas);
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title">
                                                <center>
                                                    <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-archive"></i> Tapas en stock</button>
                                                </center>
                                            ...
                                            <div class="table-responsive">
                                                <table id="example" class="table table-striped table-bordered table-hover flip-content" id="tabla" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $id=1; while ($row=mysqli_fetch_array($inventarioTapas)) { ?>
                                                        <tr>
                                                            <td><?php echo $id ?></td>
                                                            <td><?php echo $row['tamano'];?></td>
                                                            <td><?php echo $row['unidad_medida'];?></td>
                                                            <td><strong><?php echo $row['cantidad'];?></strong></td>
                                                                   <?php  $cantidadInventarioTapas=$row['cantidad'];?>
                                                        <td>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <section class="">
                                            ...
                                            <center>
                                                <h5> <i class="fa fa-close" aria-hidden="true"></i> No se han  agregado tapas al inventario</h5>
