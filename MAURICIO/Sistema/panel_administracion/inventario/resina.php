...
$query="SELECT resina.id_resina, resina.nombre, resina.unidad_medida, inventario_resina.id_resina, inventario_resina.cantidad, inventario_resina.id_inventarioResina FROM resina, inventario_resina WHERE inventario_resina.id_resina=resina.id_resina";
$inventarioResina=mysqli_query($conexion,$query);
$filas=mysqli_num_rows($inventarioResina);
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title">
                                        ...
                                        <a href="../reportes/inventario_resina.php"><button title="Lista de clientes" class="btn   btn-sm rounded-s btn-danger test"> <i class="fa fa-file-pdf-o  fa-lg"></i></button></a>
                                    </h3>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title">
                                                <center>
                                                    <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-archive"></i> Resina en stock</button>
                                                </center>
                                            ...
                                            <div class="table-responsive">
                                                <table id="example" class="table table-striped table-bordered table-hover flip-content" id="tabla" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $id=1; while ($row=mysqli_fetch_array($inventarioResina)) { ?>
                                                        <tr>
                                                            <td><?php echo $id ?></td>
                                                            <td><?php echo $row['nombre'];?></td>
                                                            <td><?php echo $row['unidad_medida'];?></td>
                                                            <td><strong><?php echo $row['cantidad'];?></strong></td>
                                                          <?php $cantidadInventarioResina=$row['cantidad'];?>
                                                        <td>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <section class="">
                                            ...
                                            <center>
                                                <h5> <i class="fa fa-close" aria-hidden="true"></i> No se han  agregado resinas al inventario</h5>
