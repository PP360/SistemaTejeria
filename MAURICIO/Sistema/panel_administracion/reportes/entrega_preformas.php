...
$pdf->Cell(25,8, 'No.Caja', 1 );
$pdf->Cell(30,8,utf8_decode('Cantidad Pzas.'), 1);
$pdf->Cell(35,8,'Fecha de Entrega',1);
$pdf->Ln();
$pdf->SetFont('Arial','',12);
$preforma="SELECT P.gramaje, P.unidad_medida, EP1.id_entregaPreformas, DE.NumeroCaja,DE.cantidad, EP1.fecha_entrega FROM entrega_preformas EP1, entrega_preformas EP2, usuarios U1, usuarios U2, detalle_entregapreformas DE,preformas P WHERE U1.id_usuario=EP1.id_usuarioEntrega AND U2.id_usuario=EP1.id_usuarioRecibe  AND EP1.id_entregaPreformas=DE.id_entregaPreformas AND P.id_preforma=DE.id_preforma AND DE.id_entregaPreformas='$id' GROUP BY  EP1.id_entregaPreformas";
...
if (mysqli_num_rows($prefor)>0)
{
    ...
    {       
        ...
        $pdf->Cell(25,8, $arreglo['NumeroCaja'], 1);
        $pdf->Cell(30,8, $arreglo['cantidad'], 1);
		$date=date_create($arreglo['fecha_entrega']);
