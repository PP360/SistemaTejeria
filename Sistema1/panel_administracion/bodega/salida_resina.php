...
$query="SELECT ER1.id_entregaResina, ER1.fecha_entrega, (U1.nombre_usuario) entrego, (U2.nombre_usuario) recibe FROM entrega_resina ER1, entrega_resina ER2, usuarios U1, usuarios U2 WHERE U1.id_usuario=ER1.id_usuarioEntrega AND U2.id_usuario=ER1.id_usuarioRecibe GROUP BY  ER1.id_entregaResina";
$entregaResina=mysqli_query($conexion,$query);
$filas=mysqli_num_rows($entregaResina);
$resina="SELECT R.nombre,R.id_resina FROM inventario_resina IR, resina R WHERE R.id_resina=IR.id_resina";
$resin=mysqli_query($conexion,$resina);
$filasResina=mysqli_num_rows($resin);
$consulta1 = mysqli_query($conexion,'SELECT MAX(id_entregaResina) as id_entregaResina FROM entrega_resina LIMIT 1');
$consulta = mysqli_fetch_array($consulta1);
$numero = (empty($consulta['id_entregaResina']) ? 1 : $consulta['id_entregaResina']+=1);
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title">
                                                <center>
                                                    <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-archive"></i> Salida de resina</button>
                                                </center>
                                        ...
                                        <section>
                                            ...
                                            <center>
                                                <form action="../reportes/entregas_resinas.php" method="post">
                                                    <strong> Desde&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                                ...
                                                <table id="example" class="table table-striped table-bordered table-hover flip-content" id="tabla" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <a href="../reportes/entrega_resina.php?Cod=<?php echo base64_encode($row['id_entregaResina'])?>">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <section class="">
                                            ...
                                            <center>
                                                <h5> <i class="fa fa-close" aria-hidden="true"></i> No se han realizado entregas de resina a producción </h5>
                ...
                <div class="modal fade" id="registroSalida"  role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form action="r_salidaResina.php" method="post">
                                <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                    <center>
                                        <h4 class="modal-title"><i class="fa fa-archive"></i> Salida de resina</h4> </center> </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <?php if($filasResina>0){ ?>
                                            ...
                                            <select class="form-control form-control-sm" name="nombre" id="nombre">
                                                ...
                                                <?php while ($row=mysqli_fetch_array($resin)) { ?>
                                        ...
                                        <?php } else { ?>
                                                <div class="col-sm-10">
                                            <select class="form-control form-control-sm" name="nombre" id="nombre">
                                                <option value="0">No hay resinas registradas en el inventario </option>
                                            </select>
                                        </div>
                                        <?php } ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="cantidad" id="cantidad" class="form-control" placeholder="" required maxlength="10" onkeypress="numeros()" > </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 form-control-label">Recibio</label>
