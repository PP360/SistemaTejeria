...
$query="SELECT EP1.id_entregaPreformas, EP1.fecha_entrega, (U1.nombre_usuario) entrego, (U2.nombre_usuario) recibe FROM entrega_preformas EP1, entrega_preformas EP2, usuarios U1, usuarios U2 WHERE U1.id_usuario=EP1.id_usuarioEntrega AND U2.id_usuario=EP1.id_usuarioRecibe AND EP1.id_usuarioEntrega='$idEntrega' GROUP BY  EP1.id_entregaPreformas";
...
$tapas = mysqli_query($conexion, "SELECT t.id_tapa, t.tamano, i.cantidad FROM tapas t, inventario_tapas i WHERE t.id_tapa = i.id_tapa");
$filasTapas = mysqli_num_rows($tapas);
                        ...
                        <div class="modal-content">
                            <form action="r_salidaPreformas.php" method="post">
                                <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    ...
                                    <center>
                                        <h4 class="modal-title"><i class="fa fa-archive"></i> Salida de preformas</h4> </center> </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <?php if($filasPreformas>0){ ?>
                                           <div class="col-sm-10">
                                            <select class="form-control form-control-sm" name="gramaje" id="gramaje" required>
                                    ...
                                    <div class="form-group row">
                                        <label for="tapas" class="col-sm-2 form-control-label">Tapas</label>
                                        <?php if ($filasTapas > 0){?>
                                        <div class="col-sm-10">
                                            <select name="tapas" id="tapas" class="form-control form-control-sm" required>
                                                <option value="">Seleccione una opción</option>
                                                <?php
                                                    while($row = mysqli_fetch_array($tapas)){
                                                        echo '<option value="'.$row['id_tapa'].'">'.$row['tamano'].'</option>';
                                                    }
                                                ?>
                                            </select>                                            
                                        </div>
                                        <?php } else{?>
                                        <div class="col-sm-10">
                                            <select class="form-control form-control-sm" name="tapas" id="tapas">
                                                <option value="">No hay tapas registradas en el inventario</option>
                                            </select>
                                        </div>
                                        <?php }?>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control form-control-sm" name="recibe" id="recibe" required>
                                                <option value="">Seleccione una opción </option>
