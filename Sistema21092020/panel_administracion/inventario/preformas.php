...
$query="SELECT preformas.id_preforma, preformas.gramaje, preformas.unidad_medida, inventario_preformas.id_preforma, inventario_preformas.id_inventarioPreformas,inventario_preformas.cantidad FROM preformas, inventario_preformas WHERE inventario_preformas.id_preforma=preformas.id_preforma";
$inventarioPreformas=mysqli_query($conexion,$query);
$filas=mysqli_num_rows($inventarioPreformas);
                ...
                <section class="section">
                    <div class="title-block">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="title">
                                    Inventario de preformas
                                    <a href="../reportes/inventario_preformas.php"><button title="Lista de clientes" class="btn   btn-sm rounded-s btn-danger test"> <i class="fa fa-file-pdf-o  fa-lg"></i></button></a>
                                </h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-block">
                                    <div class="card-title-block">
                                        <h3 class="title">
                                            <center>
                                                <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-archive"></i> Preformas en stock</button>
                                            </center>
                                        ...
                                        <div class="table-responsive">
                                            <table id="example" class="table table-striped table-bordered table-hover flip-content" id="tabla" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $id=1; while ($row=mysqli_fetch_array($inventarioPreformas)) { ?>
                                                    <tr>
                                                        <td><?php echo $id ?></td>
                                                        <td class="danger"><?php echo $row['gramaje'];?></td>
                                                        <td><?php echo $row['unidad_medida'];?></td>
                                                        <td><strong><?php echo $row['cantidad'];?></strong></td>
                                                        <?php $cantidadInventario=$row['cantidad'];?>
                                                        <td>
                            ...
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <section class="">
                                        ...
                                        <center>
                                            <h5> <i class="fa fa-close" aria-hidden="true"></i> No se han agregado preformas al inventario</h5>
