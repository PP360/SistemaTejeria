...
for($i = 0;$i<$_SESSION['contadorPreformas'];$i++){
    if ($_SESSION['Preforma'][$i]!=0)
    {
        ...
        if($filas>0)
        {
            ...
            $peticion2 = "INSERT INTO compra_preformas(codigo_compraPreformas,id_proveedor,total_compra) VALUES ('$codigo','$proveedor','$total')";
            $resultado2 = mysqli_query($conexion, $peticion2);
            $peticion3 = "INSERT INTO detalle_comprapreformas(id_preforma,codigo_compraPreformas,cantidad) VALUES ('$idpreforma','$codigo','$cantidad')";
