    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function calcularPreformas() {
                ...
                console.log(document.getElementById("cajas").value);
                ...
                <div class="title-search-block">
                    <div class="title-block">
                        <div class="row">
                            ...
                            <!--
<div class="col-md-8">
    <label for="inputflete" class="col-sm-1 form-control-label">Flete:</label>
    <div class="input-group">

        <input type="text" class="form-control boxed rounded-s" id="flete" name="flete" value="0">
        <span class="input-group-btn">

            <a class="btn btn-primary  rounded-s" data-toggle="modal" data-target="#flete" data-toggle="tooltip" title="Costo del flete" data-placement="top">
                <i class="fa fa-minecart" aria-hidden="true"></i>
            </a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-3 form-control-label">Numero</label>
                                <div class="col-sm-9"> <input type="text" name="codigo" id="codigo" class="form-control" placeholder="" required disabled autofocus value="<?php echo $codigo; ?>" onkeypress="numeros()"> </div>
                            </div>
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-3 form-control-label">Proveedor</label>
                            ...
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-3 form-control-label">Tipo</label>
                            ...
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-3 form-control-label">Cantidad de cajas:</label>
                                <div class="col-sm-9">
                                    <input type="text" name="cajas" id="cajas" class="form-control" placeholder="" required maxlength="10" autofocus onkeypress="numeros()">
                                </div>

                            </div>
                            <div class="form-group row"> <label for="inputEmail3" class="col-sm-3 form-control-label">Total de preformas:</label>

                                <div class="col-sm-9"> <input type="text" name="cantidad" id="cantidad" class="form-control" placeholder="" maxlength="10" onkeypress="numeros()"> </div>
                            </div>
