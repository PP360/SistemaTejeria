                        ...
                        <div class="modal-content">
                            <form action="r_preformas.php"  method="post">
                                <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    ...
                                    <center>
                                        <h4 class="modal-title"><i class="fa fa-archive"></i> Registro de preformas</h4> </center> </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row"> <label for="inputEmail3" class="col-sm-2 form-control-label">Concepto</label>
                                        <div class="col-sm-10"> <input type="text" name="gramaje" id="gramaje" class="form-control" placeholder="" required maxlength="50" > </div>
                                    </div>
                                    <div class="form-group row"> <label for="inputEmail3" class="col-sm-2 form-control-label">Precio</label>
                                        <div class="col-sm-10"> <input type="text" name="dolar" id="dolar" class="form-control" placeholder="" required maxlength="10" onkeypress="return onKeyDecimal(event,this);"  > </div>
                                    </div>
                                </div>
