...
$invenTapa=mysqli_query($conexion,$invenTapas);
$filasTapas=mysqli_num_rows($invenTapa);
                                ...
                                <div class="card sameheight-item stats" data-exclude="xs">
                                    <div class="card-block">
                                        <div class="title-block">
                                            <h4 class="title">
                                                <center>
                                                    <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-edit"></i> Inventario de preformas</button>
                                                </center>
                                            </h4>
                                ...
                                <div class="card sameheight-item stats" data-exclude="xs">
                                    <div class="card-block">
                                        <div class="title-block">
                                            <h4 class="title">
                                                <center>
                                                    <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-edit"></i> Inventario de resina</button>
                                                </center>
                                            </h4>
                                ...
                                <div class="card sameheight-item stats" data-exclude="xs">
                                    <div class="card-block">
                                        <div class="title-block">
                                            <h4 class="title">
                                                <center>
                                                    <button type="button" class="btn btn-primary btn-sm btn-block"> <i class="fa fa-edit"></i> Inventario de tapas</button>
                                                </center>
                                            </h4>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover flip-content display" id="tabla" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php while ($row=mysqli_fetch_array($invenTapa)) { ?>
