...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->Cell(190,25,utf8_decode('L I S T A  D E  B O T E L L A S   '),0,0,'C');
        $this->Ln(25);
...
$pdf->Cell(13,8,"",0);
$pdf->Cell(30,8, 'No.', 1 );
$pdf->Cell(90,8,utf8_decode('Tipo'), 1);
$pdf->Cell(45,8, 'Unidad', 1);
$pdf->Ln();
$pdf->SetFont('Arial','',12);
$resina="SELECT * FROM botellas";
...
while($arreglo=mysqli_fetch_array($resi))
{
    ...
    $pdf->Cell(13,8,"",0);
    $pdf->Cell(30,8, $id, 1);
    $pdf->Cell(90,8, $arreglo['tipo_botella'], 1);
