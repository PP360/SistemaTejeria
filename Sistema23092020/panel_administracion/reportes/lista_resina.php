...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->Cell(190,25,utf8_decode('L I S T A  D E  R E S I N A  '),0,0,'C');
        $this->Ln(25);
...
$pdf->Cell(13,8,"",0);
$pdf->Cell(40,8, 'No.', 1 );
$pdf->Cell(40,8,utf8_decode('Nombre'), 1);
$pdf->Cell(45,8, 'Unidad', 1);
$pdf->Cell(45,8, 'Precio', 1);
$pdf->Ln();
$pdf->SetFont('Arial','',12);
$resina="SELECT * FROM resina";
$resi=mysqli_query($conexion,$resina);
$id=1;
while($arreglo=mysqli_fetch_array($resi))
{
    $pdf->SetFont('Arial','',10); //Arial, negrita, 12 puntos
    $pdf->Cell(13,8,"",0);
    $pdf->Cell(40,8, $id, 1);
    $pdf->Cell(40,8, $arreglo['nombre'], 1);
    $pdf->Cell(45,8, $arreglo['unidad_medida'], 1);
    $pdf->Cell(45,8, $arreglo['precio'], 1);
    $id++;
    $pdf->Ln(8);
}
    $pdf->Ln();
