...
$query="SELECT ER1.id_entregaResina, ER1.fecha_entrega, (U1.nombre_usuario) entrego, (U2.nombre_usuario) recibe FROM entrega_resina ER1, entrega_resina ER2, usuarios U1, usuarios U2 WHERE U1.id_usuario=ER1.id_usuarioEntrega AND U2.id_usuario=ER1.id_usuarioRecibe AND ER1.id_usuarioEntrega='$id' GROUP BY  ER1.id_entregaResina";
